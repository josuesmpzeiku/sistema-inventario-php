...
<html>
    ...
    <body>         
        <div class="color-arriba"><h2 class ="subtitulo">DETALLE DE VENTA PARA  <?php echo $nompa;?></h2></div> 
        <div class="fila">
            <div class="columna">
        ...
        <?php 
                ...
                if ($ussera == NULL or $ussera == 0){
                    ...
                    if ($idmed != NULL) { 
                        if ($cantpro != 0){                        
                            ...
                            $sql4 ="insert into bitacora values ('NULL', '".$ussera."', 'ASESOR AGREGÓ MEDICAMENTO ".$idmed.", CONTRASEÑA ".$idaten."', 'INSERT', '".$fechabitacora."')";
            ...
            echo "<form name='form' method='post' action=''>";               
                ...
                print "</table>";
                print "<div id='botones'><a class='btn-universal' href='printreceta.php?perfil=$ussera&atencion=$idaten' target='_blank'><span class='icon icon-plus'></span></a></div>";
