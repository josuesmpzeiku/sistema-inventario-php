...
<html>
    ...
    <body>
        <div class="color-arriba"><h2 class ="subtitulo">STOCK Global</h2></div>
        <div class="fila">
            <div class="columna">
                <input class="decorar-input" name="tbuscarp" id="tbuscarp" type="text" placeholder="Escriba un Código o Descripcion de Producto para Búsqueda" required>                        
                <div id="bpro" class="color-arriba"></div>
            </div>
        </div>
        <?php
