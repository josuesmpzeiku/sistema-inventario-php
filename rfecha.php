...
<html>
    ...
    <body>
        <div class="color-arriba"><h2 class ="subtitulo">REPORTE TOTAL POR FECHA</h2></div> 
        <div class="fila">
       ...
       <div class="fila">
            ...
            $fecha2 = $_POST['tfecha2'];   
               $sql1="SELECT idarm, fecharm, tipoarm, prearm1, tipolarm, talladoarm, materialarm, gradarm, addarm, prearm2 FROM armado 
                      WHERE date(armado.fecharm) BETWEEN '".$fecha1."' AND '".$fecha2."'";
                ...
                $sql2="SELECT COUNT(*), SUM(prearm1), SUM(prearm2) FROM armado 
                       WHERE date(armado.fecharm) BETWEEN '".$fecha1."' AND '".$fecha2."'";
