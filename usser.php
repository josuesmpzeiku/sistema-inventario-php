...
<html>
    ...
    <body>
            ...
            <div class="columna">		
                <form name="form1" method="post" action=""> 
                    ...
                    <select name="tpusuario" class="decorar-input" required="">
                        ...
                        <option value="G">H Inventario</option>
                        <option value="I">I Supervisor</option>
                    </select>
        ...
        <div class ="fila">
            <div class ="columna">
                <?php
                $sql3="SELECT usuario.nomusuario, usuario.userusuario, usuario.passusuario, usuario.puestousuario, tienda.nomtienda
                       from usuario inner join tienda on tienda.idtienda = usuario.idtienda  ORDER BY tienda.idtienda ASC";
                $resultado3 = mysqli_query($conn, $sql3);                
