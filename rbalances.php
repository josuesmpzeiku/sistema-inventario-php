    ...
    <body>
        ...
        <?php                   
            ...
            if (isset ($_POST['selectbv'])){ 
                $sql5 ="SELECT SUM(montog) FROM gasto WHERE fecg BETWEEN '".$fecha1."' AND '".$fecha2."' AND idtienda = '".$tienda."'";
                $resultado5 = mysqli_query($conn, $sql5);
                if ($row5 = mysqli_fetch_row($resultado5)){ }
                $sql6 ="SELECT SUM(cantpago) FROM pago WHERE fecpago BETWEEN '".$fecha1."' AND '".$fecha2."' AND idtienda = '".$tienda."'";
                ...
                print "<div class='fila'>";
                    ...
                    print "<h3>TOTAL DEL $fecha1 AL $fecha2</h3>";
                        ...
                        $sql9="SELECT tipopago, concat('Q ',SUM(cantpago)) FROM pago  
                                WHERE fecpago BETWEEN '".$fecha1."' AND '".$fecha2."' AND idtienda = $tienda GROUP BY tipopago";
                    ...
                    print "</div>"; 
                print "</div>";
                $sql ="SELECT ROW_NUMBER() OVER () AS numf, fecg, descg, qrega, CONCAT('Q ', montog) FROM `gasto` WHERE idtienda = $tienda AND fecg BETWEEN '".$fecha1."' AND '".$fecha2."'";
                $resultado = mysqli_query($conn, $sql);               
                print "<div class='fila'>";                
                ...
                print "<div class='fila'>";
                    ...
                    print "</table>";                     
                print "</div>";
                $sql1 ="SELECT ROW_NUMBER() OVER () AS numf, fecpago, idventa, CONCAT('Q ',cantpago) FROM pago WHERE tipopago = 'Efectivo' and idtienda = 1 AND fecpago BETWEEN  '".$fecha1."' AND '".$fecha2."'";
