            ...
            if (isset ($_POST['insertrep'])){ 
                if ($ussera == NULL or $ussera == 0){
                    ...
                    if ($idlente != NULL) {                
                            ...
                            $sql8 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR AGREGÓ REPARACIÓN ".$idlente.", CONTRASEÑA ".$idaten."', 'INSERT', CURRENT_TIMESTAMP)";
            ...
            if (isset ($_POST['insertm'])){ 
                if ($ussera == NULL or $ussera == 0){
                    ...
                    if ($idlente2 != NULL) {                
                            ...
                            $sql8 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR AGREGÓ MATERIAL LENTE ".$idlente2.", CONTRASEÑA ".$idaten."', 'INSERT', CURRENT_TIMESTAMP)";
                            $resultado8 = mysqli_query($conn, $sql8);
                ...
                if ($ussera == NULL or $ussera == 0){
                    ...
                    if ($idaro != NULL) { 
                        if ($cantpro != 0){                        
                            ...
                            $sql12 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR AGREGÓ ARO ".$idaro.", CONTRASEÑA ".$idaten."', 'INSERT', CURRENT_TIMESTAMP)";
            ...
            if (isset ($_POST['insertser'])){ 
                if ($ussera == NULL or $ussera == 0){
                    ...
                    if ($idserv != NULL) {  
                            ...
                            $sql15 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR AGREGÓ SERVICIO ".$idserv.". CONTRASEÑA ".$idaten."', 'INSERT', CURRENT_TIMESTAMP)";
                ...
                if ($ussera == NULL or $ussera == 0){
                    ...
                    if ($idac != NULL) { 
                        if ($cantpro != 0){                        
                            ...
                            $sql4 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR AGREGÓ ACCESORIO ".$idac.", CONTRASEÑA  ".$idaten."', 'INSERT', CURRENT_TIMESTAMP)";
                            $resultado4 = mysqli_query($conn, $sql4);
                ...
                print "<table class = 'TablaD'>";
                    ...
                    while ($row4 = mysqli_fetch_array($resultado4)){ 
                        ...
                        if (isset ($_POST['updv'.$fila])){ 
                            ...
                            $sql7 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR MODIFICÓ PRECIO % A ".$row4['descproducto'].", CONTRASEÑA  ".$idaten."', 'UPDATE', CURRENT_TIMESTAMP)";
                            $resultado7 = mysqli_query($conn, $sql7);
                        ...
                        if (isset ($_POST['deldv'.$fila])){                                                                           
                            ...
                            $sql10 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR ELIMINÓ ".$row4['descproducto'].", CONTRASEÑA  ".$idaten."', 'DELETE', CURRENT_TIMESTAMP)";
                            $resultado10 = mysqli_query($conn, $sql10);
                ...
                if (isset ($_POST['insertma'])){
                    if ($ussera == NULL or $ussera == 0){
                        ...
                        if ($idbitacora == NULL) {
                            ...
                            $sql3 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR AGREGÓ MEDIDA DE ARO CONTRASEÑA ".$idaten."', 'INSERT', CURRENT_TIMESTAMP)";
                            $resultado3 = mysqli_query($conn, $sql3);
                     ...
                     if ($anticipo != $row[0]){
                        ...
                        if($tcantp <= $pendiente){
                           $sql2 ="insert into pago values (NULL, '".$idaten."', '".$ttpa."', '".$tcantp."',  '".$tfecp."', '".$doc."', '".$tienda."')";
                            ...
                            $sql3 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR INGRESO PAGO DE Q".$tcantp.".00  A CONTRASEÑA ".$idaten."', 'INSERT', CURRENT_TIMESTAMP)";
                            $resultado3 = mysqli_query($conn, $sql3);
                ...
                if($row9 = mysqli_fetch_array($resultado9)){ $tpa = $row9["SUM(pago.cantpago)"]; $tve =$row9["totalventa"];} 
                    ...
                    if($tpa != $tve or $tpa == NULL){                        
                      print "<script> alert('NO PUEDE FINALIZAR EL PROCESO HASTA QUE EL COSTO TOTAL SEA CANCELADO');</script>";  
                        ...
                        $sql8 ="insert into bitacora values (NULL, '".$ussera."', 'ASESOR FINALIZÓ CONTRASEÑA ".$idaten." EN PAGOS', 'UPDATE', CURRENT_TIMESTAMP)";
                        $resultado8 = mysqli_query($conn, $sql8);
