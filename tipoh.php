    ...
    <body> 
        ...
        <div class="contenedor-principal">		                        
                ...
                <div class="inner">                            
                    <nav id="tmMainNav" class="tm-main-nav">
                        <ul>
                            ...
                            <li><a href="bodega.php?perfil=<?php echo $ussera; ?>" target="principal"><span class="icon icon-box-add"></span>  Bodega</a></li>
                            <li><a href="sucursal.php?perfil=<?php echo $ussera; ?>" target="principal"><span class="icon icon-truck"></span>  Sucursal</a></li>
                            <li><a href="stock.php?perfil=<?php echo $ussera; ?>" target="principal"><span class="icon icon-barcode"></span>  Stock</a></li>
                            <li><a href="rventas.php?perfil=<?php echo $ussera; ?>" target="principal"><span class="icon icon-cart"></span>  Ventas</a></li>
                            <li><a href="rdiario.php?perfil=<?php echo $ussera; ?>" target="principal"><span class="icon icon-book"></span>  Libro Diario</a></li>
                            <li><a href="rbalancesv.php?perfil=<?php echo $ussera; ?>" target="principal"><span class="icon icon-stats-bars"></span>  Reporte GV</a></li> 
                            ...
                            <li><a href="devoluciones.php?perfil=<?php echo $ussera; ?>" target="principal"><span class="icon icon-loop2"></span>  Devoluciones</a></li>                                                      
            ...
            <div class="derecha tm-content">
                 <iframe width = "100%" height = "100%" frameborder="0" NAME="principal" SRC="invensucursal.php?perfil=<?php echo $ussera; ?>"></iframe>                        
            </div>		
        </div>        
